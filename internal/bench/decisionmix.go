...
type DecisionMix struct {
	...
	// SpillHitRate and SpillLoad are the two spill conditions, and they stay two
	...
	// separately.
	SpillHitRate int `json:"spill_hit_rate" parquet:"spill_hit_rate"`
...
func (m *DecisionMix) count(reason string) {
	...
	case policy.ReasonPromptUnhashed:
		m.PromptUnhashed++
	case policy.ReasonSpillHitRate:
		m.SpillHitRate++
...
func (m DecisionMix) Spilled() int { return m.SpillHitRate + m.SpillLoad }
