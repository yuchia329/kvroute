...
Of the rest, 1500 succeeded, 44 of them outside the SLO; 0 failed with an error their replica answered with; 0 were cancelled by their client.

## Recovery

- Baseline goodput before the fault: 5.98/s
- Lowest from the fault on: 3.00/s, in the bucket at +70.00s
- Deficit: 43 requests that would have met the SLO at the baseline did not
- Back within 10% of the baseline from +80.00s, and there to the end of the run
...
| +170.00s | 30 | 6.00 | 0 | 0 | 0 | 0 |
| +175.00s | 30 | 6.00 | 0 | 0 | 0 | 0 |
