...
Goodput delta between **prefix_affinity** and **exact_residency** across the working set × skew grid,
at a single concurrency. Positive means exact_residency served more requests inside the SLO.
...
|---|---:|---:|---:|---:|---:|---|
| WS 0.25, skew 0 | 2329468 | 3.3 pp | 0 | 1561 | 4.163% | yes |
| WS 0.25, skew 1 | 1540357 | 1.4 pp | 0 | 852 | 2.546% | yes |
| WS 0.25, skew 1.4 | 1089035 | 0.8 pp | 0 | 638 | 2.303% | yes |
| WS 1, skew 0 | 1987815 | 1.2 pp | 0 | 495 | 2.856% | yes |
| WS 1, skew 1 | 1871131 | 2.5 pp | 0 | 851 | 3.534% | yes |
| WS 1, skew 1.4 | 2013627 | 1.0 pp | 0 | 518 | 1.853% | yes |
| WS 3, skew 0 | 1249482 | 1.2 pp | 0 | 158 | 1.258% | yes |
| WS 3, skew 1 | 3580191 | 1.6 pp | 0 | 639 | 3.142% | yes |
| WS 3, skew 1.4 | 1639158 | 0.7 pp | 0 | 528 | 1.983% | yes |
| WS 8, skew 0 | 947444 | 1.5 pp | 0 | 147 | 1.436% | yes |
| WS 8, skew 1 | 1413505 | 1.7 pp | 0 | 542 | 3.239% | yes |
| WS 8, skew 1.4 | 1764897 | 0.9 pp | 0 | 595 | 2.437% | yes |

The mechanism fired and at least one point separated by more than its spread.
The map below is measuring the policies.

## The map — Δ goodput, exact_residency against prefix_affinity
...
| point | load | session_affinity | prefix_affinity | exact_residency |
|---|---:|---:|---:|---:|
| WS 0.25, skew 0 | 32 users | 34.53 (29.13–35.48, n=3)<br>±18% | 32.15 (31.95–34.53, n=3)<br>±8% | 30.00 (29.27–30.95, n=3)<br>±6% |
| WS 0.25, skew 1 | 32 users | 8.71 (8.71–24.78, n=2)<br>±184% | 34.66 (34.62–36.03, n=3)<br>±4% | 31.69 (30.70–34.04, n=3)<br>±11% |
| WS 0.25, skew 1.4 | 32 users | 7.07 (5.17–13.87, n=3)<br>±123% | 35.16 (34.91–36.28, n=3)<br>±4% | 32.46 (32.27–33.99, n=3)<br>±5% |
| WS 1, skew 0 | 32 users | 9.15 (8.57–9.97, n=3)<br>±15% | 15.17 (15.04–15.22, n=3)<br>±1% | 13.78 (13.19–14.25, n=3)<br>±8% |
| WS 1, skew 1 | 32 users | 17.31 (12.43–18.37, n=3)<br>±34% | 23.18 (23.00–23.99, n=3)<br>±4% | 21.16 (21.14–21.42, n=3)<br>±1% |
| WS 1, skew 1.4 | 32 users | 10.43 (10.43–13.55, n=2)<br>±30% | 30.63 (30.06–31.84, n=3)<br>±6% | 28.34 (28.02–29.96, n=3)<br>±7% |
| WS 3, skew 0 | 32 users | 8.97 (8.13–9.67, n=3)<br>±17% | 11.64 (11.50–11.75, n=3)<br>±2% | 10.45 (10.16–10.64, n=3)<br>±5% |
| WS 3, skew 1 | 32 users | 12.00 (12.00–13.50, n=2)<br>±13% | 19.02 (19.00–19.43, n=3)<br>±2% | 17.39 (17.28–17.76, n=3)<br>±3% |
| WS 3, skew 1.4 | 32 users | 6.55 (5.91–11.38, n=3)<br>±83% | 28.95 (28.78–29.16, n=3)<br>±1% | 27.60 (26.64–27.78, n=3)<br>±4% |
| WS 8, skew 0 | 32 users | 8.71 (8.06–9.03, n=3)<br>±11% | 10.76 (10.65–10.99, n=3)<br>±3% | 9.30 (9.01–9.72, n=3)<br>±8% |
| WS 8, skew 1 | 32 users | 13.76 (12.97–14.43, n=3)<br>±11% | 17.42 (16.83–17.47, n=3)<br>±4% | 15.08 (14.74–15.39, n=3)<br>±4% |
| WS 8, skew 1.4 | 32 users | 10.37 (6.72–11.72, n=3)<br>±48% | 28.23 (27.82–28.35, n=3)<br>±2% | 26.46 (25.62–26.58, n=3)<br>±4% |
